...
L82:
   ...
   mov		r8, 16
   call		memcpy
   lea		rax, runtime_builtin_append
   push		rax
   pop		rax
   mov		-160[rbp], rax
   lea		rax, -72[rbp]
...
L99:
   ...
   push		rbx
   pop		rbx
   lea		rax, StringBuilder.internalGrow
   push		rax
   pop		rax
   mov		-56[rbp], rax
   mov		rax, -8[rbp]
...
StringBuilder.addStringSlice:
   ...
   push		rbx
   pop		rbx
   lea		rax, StringBuilder.internalAdd
   push		rax
   pop		rax
   mov		-104[rbp], rax
   mov		rax, -8[rbp]
...
StringBuilder.addAnyValue:
   ...
   push		rbx
   pop		rbx
   lea		rax, StringBuilder.addUInt64
   push		rax
   pop		rax
   mov		-616[rbp], rax
   mov		rax, -8[rbp]
...
L129:
   ...
   push		rbx
   pop		rbx
   lea		rax, StringBuilder.addInt64
   push		rax
   pop		rax
   mov		-616[rbp], rax
   mov		rax, -8[rbp]
...
L126:
   ...
   push		rbx
   pop		rbx
   lea		rax, StringBuilder.addString
   push		rax
   pop		rax
   mov		-616[rbp], rax
   mov		rax, -8[rbp]
...
L122:
   ...
   push		rbx
   pop		rbx
   lea		rax, StringBuilder.addFloat32
   push		rax
   pop		rax
   mov		-616[rbp], rax
   mov		rax, -8[rbp]
...
L135:
   ...
   push		rbx
   pop		rbx
   lea		rax, StringBuilder.addFloat64
   push		rax
   pop		rax
   mov		-616[rbp], rax
   mov		rax, -8[rbp]
...
L147:
   ...
   push		rbx
   pop		rbx
   lea		rax, StringBuilder.addAnyValue
   push		rax
   pop		rax
   mov		-616[rbp], rax
   mov		rax, -8[rbp]
...
L162:
   ...
   push		rbx
   pop		rbx
   lea		rax, StringBuilder.addStringSlice
   push		rax
   pop		rax
   mov		-208[rbp], rax
   mov		rax, -8[rbp]
...
L175:
   ...
   push		rax
   pop		rbx
   lea		rax, StringBuilder.toString
   push		rax
   pop		rax
   mov		-240[rbp], rax
   lea		rax, -256[rbp]
