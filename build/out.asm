...
main:
   ...
   ; Ln 197: $window_width : int = -8
   mov		rax, 1200
   push		rax
   pop		rax
   mov		DWORD -8[rbp], eax

   ; Ln 198: $window_height : int = -12
   mov		rax, 800
   push		rax
   pop		rax
   ...
   ; Ln 204: $text : string = -20
   mov		rax, CS1
   push		rax
   pop		rax
   mov		QWORD -20[rbp], rax

   ; Ln 205: $text_len : int = -28
   mov		rax, QWORD -20[rbp]
   push		rax
   mov		rax, 24
   push		rax
   pop		rax
   ...
   ; Ln 211: $ball_size : int = -48
   mov		rax, 20
   push		rax
   pop		rax
   mov		DWORD -48[rbp], eax

   ; Ln 213: $bar_width : float = -52
   movss		xmm0, [CF6]
   movd		eax, xmm0
   push		rax
   pop		rax
   ...
   ; Ln 223: $brick_row_width : int = -1500
   push		80
   push		15
   pop		rbx
   pop		rax
...
L123:
   ...
   push		rax
   pop		rax
   mov		BYTE -1652[rbp], al
   mov		rax, 30
   push		rax
   pop		rax
   mov		BYTE -1651[rbp], al
   mov		rax, 30
   push		rax
   pop		rax
   mov		BYTE -1650[rbp], al
   mov		rax, 30
   push		rax
   pop		rax
   mov		BYTE -1649[rbp], al
   mov		eax, -1652[rbp]
   push		rax
   pop		rax
   mov		ecx, eax
   ...
   mov		rbx, 0[rax]
   mov		rcx, 8[rax]
   mov		-1632[rbp], rbx     ; data
   mov		-1640[rbp], rcx     ; count
   mov		QWORD -1648[rbp], 0 ; index
L124:
   mov		rbx, -1640[rbp]
   mov		rax, -1648[rbp]
   cmp		rax, rbx
   ...
   mov		rax, 8[rbx]
   mov		-1616[rbp], rax
   mov		eax, DWORD -1624[rbp]
   movsx		rax, eax
   push		rax
   mov		eax, DWORD -1620[rbp]
   movsx		rax, eax
   push		rax
   push		80
   push		20
